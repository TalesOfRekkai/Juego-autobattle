...
const translations = {
    es: {
        ...
        detail_resting: (h: number, m: number, _s: number) => `💤 Descanso en ${h}h ${m.toString().padStart(2, '0')}m`,
    ...
    en: {
        ...
        detail_resting: (h: number, m: number, _s: number) => `💤 Rest in ${h}h ${m.toString().padStart(2, '0')}m`,
